...
const sharedBoxStyle = {
    ...
    , k = (...e)=>Object.assign({}, sharedBoxStyle, ...e)
    , x = k({
    width: "100%"
})
    , _ = k({
...
function C(e) {
    const {children: n, style: t} = e
        , r = Object.assign({}, sharedBoxStyle, {
        width: "100vw",
        height: "100vh"
    }, t);
...
function D(e) {
    return "string" == typeof e ? e : e[1]
        ...
        const F = ()=>({
          ...
          , X = {
            ...
            "more-scope": {
                ...
                questions: {
                    ...
                    scope_terminology_practice: {
                        checkboxes: [[!1, "The scope of the top-level `x` includes the whole program."], [!0, "The scope of the top-level `x` includes `(+ x 3)`."], [!1, "The top-level `x` shadows the `x` defined in `f`."], [!0, "The `x` in `(+ x 1)` is in the scope of the `x` defined in `f`."], [!0, "The `x` in `(+ x 2)` is in the scope of the `x` defined in `f`."], [!1, "The `x` in `(+ x 3)` is in the scope of the `x` defined in `f`."]],
            ...
            "mut-vars": {
                ...
                questions: {
                    attention_check1: {
                        checkboxes: [[!0, "Definitions (i.e., `defvar` and `deffun`)"], [!1, "Variable mutations (i.e., `set!`)"], [!1, "Variable references"], [!0, "Function calls"]],
                    ...
                    attention_check2: {
                        checkboxes: [[!1, "Definitions (i.e., `defvar` and `deffun`)"], [!0, "Variable mutations (i.e., `set!`)"], [!1, "Variable references"], [!1, "Function calls"]],
          ...
          , K = new URLSearchParams(Z)
          , $ = K.get("export") || !1
          , ee = K.get("tutorial") || window.tutorial || "scope"
          , ne = K.get("userId") || window.userId || "placeholder_userId"
          , te = window.google || null
          , re = X[ee];
        function ae(e) {
            var n;
            const {src: t} = e
            ...
            var o;
            for (let e of Array.from(a.getElementsByTagName("pre"))) {
                const t = l()
                  , r = s();
                t.appendChild(e.cloneNode(!0)),
                t.appendChild(r),
                null === (n = e.parentElement) || void 0 === n || n.replaceChild(t, e)
            }
            const i = a.body.innerHTML;
            return react.createElement("div", {
                style: {
                    display: "contents"
                },
            ...
            function l() {
                ...
                return e.className = "copiable-pre",
                e
            }
            function s() {
                const e = document.createElement("div");
                return e.innerHTML = `<button onclick="handleClickOfCopyButton(event, '${re.lang}')">COPY as program</button>`,
                e
            }
        }
        function oe(e) {
            try {
                ...
                return console.log(`Failed in parsing a JSON string. The string is: \`${e}\``),
                null
            }
        }
        function ie(e) {
            const {value: n, placeholder: t, onChange: r, onClick: a} = e;
            return react.createElement("input", {
                type: "text",
                autoComplete: "off",
                value: n,
                onChange: e=>r(e.target.value),
                onClick: void 0 !== a ? e=>a() : void 0,
                placeholder: t
            })
        }
        function le(e) {
            const {value: n, onClick: t, children: r} = e;
        ...
        function se(e) {
            const [n,t] = (0,
            react.useState)(null)
              , {choices: r, value: a, enableOther: o, onChange: i, onSubmit: l} = e;
            return react.createElement("form", {
                onSubmit: e=>{
                    e.preventDefault(),
                    [...r.map(D), n].indexOf(a) >= 0 && l()
                }
                ,
                style: k(z, E)
            }, react.createElement(I, null, r.map(((e,n)=>{
            ...
            )(n, r.length) : react.createElement(react.Fragment, null)), react.createElement("button", {
                type: "submit"
            }, "↟ Send ↟"))
        }
        function ue(e) {
        ...
        function de(e) {
            const {value: n, onChange: t, children: r} = e;
            return react.createElement("div", {
                onClick: e=>t(null)
            }, n ? "✅" : "🔲", " ", r)
        }
        function fe(e) {
            let {choices: n, value: t, onChange: r, onSubmit: a} = e;
            "string" != typeof t && (t = JSON.stringify(n.map((e=>!1))));
            let o = oe(t);
            return react.createElement("form", {
                onSubmit: e=>{
                    e.preventDefault(),
                ...
                ,
                style: k(z, E)
            }, react.createElement(I, null, n.map(((e,n)=>{
        ...
        function he(e) {
            const {value: n, placeholder: t, onChange: r, onSubmit: a} = e;
            return react.createElement(I, null, react.createElement("input", {
                type: "text",
                name: "user-response",
                id: "user-reponse",
                autoComplete: "off",
        ...
        function pe(e) {
            const {value: n, onChange: t, onSubmit: r} = e;
            return react.createElement(P, null, react.createElement(I, null, react.createElement(B, null, react.createElement("textarea", {
                style: k({
                    marginRight: "1ex",
                    resize: "none"
                }),
        ...
        void 0 === re && alert(`"${ee}" is not an available tutorial.`);
        ...
        function we(e) {
            const {messages: n, id: t, isSelectable: r, isSelected: a, onSelect: o} = e;
            return react.createElement("div", {
                style: k(S, {
                    padding: "1ex"
                }),
                ...
                let t = null;
                for (const r of e)
                    null === r ? null !== t && (n.length > 0 && n.push(null),
                    n.push(t),
                    t = null) : (null === t && (t = []),
                    t.push(r));
                ...
                t = null),
                n
            }(n).map(((e,n)=>null === e ? react.createElement(me, {
                key: n
            }) : react.createElement("div", {
                key: n
            }, e.map(((e,n)=>r(e) ? react.createElement(ve, {
                key: n,
                message: e,
                isSelected: a(e.id),
                onClick: ()=>o(e.id)
        ...
        function ye(e, n) {
            ...
            t.setAttribute("href", "data:text/plain;charset=utf-8," + encodeURIComponent(n)),
        ...
        const Ae = "What is the result of running this program?"
          , ke = "You got it right! 🎉🎉🎉"
          , xe = "Click to continue."
          , _e = "I am ready for the next question."
          , Ee = "I have read the error message."
          , Ce = (["You can improve the system if you can let us know what confused you. ", "Feel free to skip this question."].join(""),
        'Please enter the program result (e.g., "42 135") ...');
        function Se(e) {
            return (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = e.trim()).toLowerCase()).replaceAll(/^\s+/g, "")).replaceAll(/\s+$/g, "")).replaceAll(/\s\s+/g, " ")).replaceAll(/\(\s+/g, "(")).replaceAll(/\s+\)/g, ")")).replaceAll(/^#\(/g, "'#(")).replaceAll(/([\w)])\(/g, "$1 (")).replaceAll(/\)([\w(])/g, ") $1")).replaceAll(/([\w)])#\(/g, "$1 #(")).replaceAll(/err([^\w])/g, "error$1")).replaceAll(/err$/g, "error")).replaceAll(/error:.*$/g, "error")
        }
        function Ie(e) {
            const {order: n, questions: t} = e
              , r = [];
            for (let e of n) {
                const n = t[e];
                if ("checkboxes"in n)
        ...
        for (const [e,n] of Object.entries(X))
            for (const {task: t, choice: r, isAdded: a} of Ie(n))
                Be += "\n" + [e, t, r, a].join(",");
        function ze(e, n, t) {
        ...
        const Pe = $ ? function*(e) {
            ...
            for (let e of l) {
                const r = s[e];
                if ("checkboxes"in r) {
                    const {prompt: e, checkboxes: n, feedback: t} = r;
                    a(e),
                    a(n.map((([e,n])=>`${e ? "✅" : "🔲"} ${n}  `)).join("\n")),
                    ...
                    const {prompt: e, expected_label: n} = r;
                    a(e)
                } else if ("answer"in r)
                    if ("distractors"in r) {
                        const {prompt: e, program: n, distractors: t, answer: i, feedback: l} = r;
                        o(e, n);
                        const s = [i, ...t].map(((e,n)=>[e, n])).sort((([e,n],[t,r])=>{
                            const a = D(e)
                              , o = D(t);
                        ...
                        a(`[If the student picks the correct answer (\`${i}\`), we say:]`),
                        a(ke + `\n\n${u}`),
            ...
            function u(e, n, r, a) {
                ...
                function(e) {
                    setTimeout((function() {
                        null === te || te.script.run.withSuccessHandler((function(e) {}
                        )).withFailureHandler((function(e) {}
                        )).logClientData(ee, ne, e)
                    }
                    ))
                }([Object.assign({}, o, {
            ...
            !function(e) {
                function n(n) {
                    ...
                    ye("smol_tutor_log.json", JSON.stringify(e)),
                    ye("smol_tutor_failure_reason.json", JSON.stringify(n))
                }
                setTimeout((function() {
                    null === te ? n("This app is not connected to a Google Script backend.") : te.script.run.withSuccessHandler((function(e) {
          ...
          , Te = function(e) {
            ...
            e.returnValue = "If you leave this webpage now, your work won't be recorded."
        };
        import "./tall.css"
        createRoot(document.getElementById("root")).render(react.createElement(react.StrictMode, null, react.createElement((function() {
            var e;
            let n, t, r, a, o;
            ...
            const i = Pe.next(null)
              ...
              , c = react.createElement(we, {
                ...
                ,
                isSelected: e=>"select" === l.kind && new Set(null === n ? [] : oe(n)).has(e),
                onSelect: e=>{
                    if ("select" !== l.kind)
                        return !1;
                    {
                        const a = new Set(null === n ? [] : oe(n));
              ...
              , d = function(e, n, t, r) {
                return J(e, {
                    whenEnd: function() {
                        return window.removeEventListener("beforeunload", Te, {
                            capture: !0
                        }),
                        react.createElement("div", null, react.createElement(ae, {
                            src: "**Please wait a couple of seconds to let us record your response. There will be a pop-up window when we are done.**"
                        }))
                    },
                    whenConfirm: function(e) {
                    ...
                    whenSelect: function(e) {
                        const r = new Set("string" == typeof t ? oe(t) : []);
                        return react.createElement("button", {
                            onClick: ()=>n(),
                            style: k(x, _)
              ...
              , f = null === (e = s[s.length - 1]) || void 0 === e ? void 0 : e.id;
            return void 0 === f || f === t && "valueChange" == a || setTimeout((()=>{
                var e;
                t = f,
            ...
            h = c,
            p = d,
            react.createElement(C, null, react.createElement(I, null, h, react.createElement("div", {
                style: {
                    padding: "1ex",
                    paddingBottom: "1em",
